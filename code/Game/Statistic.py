...
#         self.algorithm_solve_time = 0  # Thời gian giải của thuật toán
#         self.show_node_expand = True  # Flag để hiển thị node expand
...
#     def set_algorithm_solve_time(self, solve_time):
#         """Cập nhật thời gian giải của thuật toán"""
#         self.algorithm_solve_time = solve_time
...
#     def set_show_node_expand(self, show):
#         """Cài đặt có hiển thị node expand hay không"""
#         self.show_node_expand = show
...
#         self.algorithm_solve_time = 0
#         self.node_expand = []
#         self.total_node = 0
#         self.total_cost = 0
#         self.show_node_expand = True
    
#     def on_level_complete(self):
#         """Được gọi khi hoàn thành level"""
#         self.show_node_expand = False
...
#         return {
#             'time_executed': self.algorithm_solve_time if self.algorithm_solve_time > 0 else self.time_executed,
...
#         """Đánh giá hiệu suất"""
#         time_to_check = self.algorithm_solve_time if self.algorithm_solve_time > 0 else self.time_executed
        
#         if time_to_check < 0.01 and len(self.node_expand) < 50:
#             return "★★★ EXCELLENT", (255, 215, 0)
#         elif time_to_check < 0.1 and len(self.node_expand) < 200:
#             return "★★☆ GOOD", (70, 130, 180)
#         elif time_to_check < 1.0 and len(self.node_expand) < 1000:
...
#         # Sử dụng thời gian giải thuật toán thay vì thời gian hoàn thành
#         display_time = self.algorithm_solve_time if self.algorithm_solve_time > 0 else self.time_executed
        
#         stats_data = [
#             ("⏱️ Time:", self.format_time(display_time), (70, 130, 180)),
#             ("📊 Total:", f"{self.total_node}", (255, 140, 0)),
#             ("💰 Cost:", f"{self.total_cost}", (238, 130, 238)),
#             ("⚡ Efficiency:", f"{self.calculate_efficiency():.2f}", (220, 20, 60))
#         ]
        
#         # Chỉ hiển thị nodes expanded khi đang giải, không hiển thị sau khi thắng
#         if self.show_node_expand:
#             stats_data.insert(1, ("🔍 Nodes:", f"{len(self.node_expand)}", (60, 179, 113)))
